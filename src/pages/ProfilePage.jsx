...
const ProfilePage = () => {
  ...
  // Initialize with empty strings to prevent errors if authUser is initially null
  const [name, setname] = useState('');
  const [bio, setbio] = useState('');

  // This effect will run when `authUser` changes, keeping the form in sync.
  useEffect(() => {
    if (authUser) {
  ...
  const handleSubmit = async (e) => {
    ...
    reader.onerror = () => {
      toast.error("There was an error reading the image file.");
    };
  }
